...
class StacksSpec extends FunSuite {
  ...
  test("To json string") {
    ...
    assertResult("""{"hobbies":["java","scala","clojure"],"username":"aiyanbo","others":{"gate":3},"age":15,"objectId":"55b89e0600b0ed9c142e221a","born":"2015-07-31T11:05:44.055Z"}""")(mapToJsonString(map))
  }
